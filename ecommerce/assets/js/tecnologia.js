document.addEventListener("DOMContentLoaded", () => {
    renderizarProductos(productosTecnologia, "contenedor-productos");
});
...
buscador.addEventListener("input", () => {
    ...
    const listaFiltrada = productosTecnologia.filter(prod => prod.nombre.toLowerCase().includes(texto));
